...
| `LoginPage`                | Password authentication form with a `ConnectionManagerPopover` (labeled "Server:") above the password form, allowing users to switch servers before logging in                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
The `ConnectionManagerPopover` is rendered in two locations: the `TopBar`'s left slot and the `LoginPage` (above the password form, labeled "Server:"). It provides a compact status indicator and a popover for managing WebSocket connections.
