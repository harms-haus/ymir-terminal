...
| `useConnectionStatus`      | Subscribes to wsClient status changes via `onStatusChange`. Returns `{ status, isConnected, isReconnecting }`. Used by `useConnectionManager`.                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `useConnectionManager`     | Orchestrates connection lifecycle: current URL/host/port tracking, favorites and recent connections CRUD (via `connection-storage.ts`), connect/disconnect/connectToLocal actions, and Tauri detection. Composes `useConnectionStatus`.                                                                                                                                                                                                                                                                                                                                                              |
