...
function main() {
  ...
  var releaseUrl = 'https://api.github.com/repos/' + GITHUB_REPO + '/releases/latest';
  ...
  httpsGetJSON(releaseUrl)
    .then(function (release) {
      ...
      if (!asset) {
        console.log('ymir: No matching binary found for ' + platformInfo.assetSuffix);
        return;
      }

      console.log('ymir: Downloading ' + asset.name + '...');
      return downloadFile(asset.browser_download_url, binaryPath).then(function () {
